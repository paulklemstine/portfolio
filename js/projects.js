...
window.PROJECTS = [
  ...
  {
    id: 'joust-ai',
    name: 'Joust AI (Self-Training Neural Champion)',
    tagline: 'A frame-stacked Deep Q-Network that models its opponents, trains itself in league matches, and ships its own improvements',
    description: 'A live multiplayer jousting bot built on a 784-input frame-stacked Deep Q-Network with opponent modeling: six online sub-networks learn each player\u2019s style and roll their predicted moves into the bot\u2019s decisions. Trained by a league self-play pipeline \u2014 6v6v6 matches with gradient DQN, behavioral cloning from human recordings, and evolutionary selection \u2014 that automatically deploys every fitness improvement, with real-match K/D telemetry and auto-rollback protection.',
    tags: ['Deep Q-Learning', 'Frame-Stacked Memory', 'Opponent Modeling', 'League Self-Play', 'Behavioral Cloning', 'Auto-Deploy Pipeline'],
