...
window.PROJECTS = [
  ...
  {
    id: 'joust-ai',
    name: 'Joust AI (Evolutionary Neural Network)',
    tagline: 'An Evolutionary Neural Network (ENN) champion with 32-input tensor physics & multi-kill combos',
    description: 'A real-time arcade jousting champion evolved across 4 speciated islands via Multi-Island Evolutionary Neural Networks (ENN) and Deep Q-Learning. Features a 32-dimensional sensory input space, BLX-α synaptic tensor crossover, 10,000-tick marathon matches, full cruising velocity optimization, screen-wrap flank strikes, and parabolic hawk-dive attacks.',
    tags: ['Evolutionary Neural Networks', 'Deep Neuroevolution', 'Deep Q-Learning', 'Genetic Algorithms', 'Multi-Island Tournament', 'Autonomous Game AI'],
